...
class CleaningTaskTemplateList {
     ...
     */
    static async new(title) {
        if (typeof title !== "string" || title === "")
            throw new ServerError_1.default("title must be a non-empty string", 400);
        try {
            const createCleaningTaskTemplateListResponse = await (0, dbconnection_1.query)(`
    ...
    static async getView(cleaningTaskTemplateListId) {
        if (typeof cleaningTaskTemplateListId !== "number") {
            throw new ServerError_1.default("cleaningTaskTemplateListId must be a number", 400);
        }
        try {
     ...
     */
    static async createCleaningTaskTemplate(cleaningTaskTemplateListId, cleaningTaskTemplateDescription, areaId, areaDescription) {
        if (!Number.isInteger(cleaningTaskTemplateListId))
            throw new ServerError_1.default("cleaningTaskTemplateListId must be an integer", 400);
