...
class LCMS_Cleaning {
     ...
     */
    static async createCleaningTaskTemplateList(title) {
        return await CleaningTaskTemplateList_1.default.new(title);
    }
    /**
    ...
    static async addCleaningTaskTemplateToCleaningTaskTemplateList(cleaningTaskTemplateListId, cleaningTaskTemplateId, cleaningTaskTemplateDescription, areaId, areaDescription) {
        if (cleaningTaskTemplateListId !== undefined &&
            ...
            return await CleaningTaskTemplateList_1.default.createCleaningTaskTemplate(cleaningTaskTemplateListId, cleaningTaskTemplateDescription, areaId, areaDescription);
    }
    /**
    ...
    static async getCleaningTaskTemplateLists() {
        try {
            const cleaningTaskTemplateLists = await (0, dbconnection_1.query)("SELECT * FROM CleaningTaskTemplateList;");
    ...
    static async getCleaningTaskTemplates() {
        try {
            const cleaningTaskTemplates = await (0, dbconnection_1.query)("SELECT * FROM CleaningTaskTemplate");
    ...
    static async getAreas() {
        try {
            const areas = await (0, dbconnection_1.query)("SELECT * FROM Area;");
            if (areas.rowCount === 0)
    ...
    static async getCleaningTaskLists() {
        try {
            const cleaningTaskLists = await (0, dbconnection_1.query)("SELECT * FROM CleaningTaskList;");
